...
<div class="container">
    ...
    <form id="regForm" class="mt-12">
        ...
        <input class="mt-12" type="checkbox" name="soglashenie" id="soglashenie" required>Согласен <a style="text-decoration: underline;" href="/php/pages/soglasie.docx" download>с соглашением на обработку персональных данных</a><br>
